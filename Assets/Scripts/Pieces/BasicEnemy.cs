...
//         movementPath = parent.aStar(this.GetTilePosition());
...
//
//       Vector3 targetWorldPos = parent.GetWorldPositionFromTilePosition(new Vector3Int((int)_targetTilePos.x, (int)_targetTilePos.y, 0));
